...
namespace MILRA_Service
{
    public static class Data2Csv
    {
        ...
        private const string basePath = @"C:\Users\shayl\new\temp\";
        ...
        public static MILRA_MODE MilraMode = MILRA_MODE.NONE;
        ...
        static Data2Csv()
        {
            ...
            /*File.Delete("C:\\Users\\shayl\\new\\temp\\training.csv");
            File.Copy("C:\\Users\\shayl\\new\\temp\\start.csv", "C:\\Users\\shayl\\new\\temp\\training.csv");

            File.WriteAllText("C:\\Users\\shayl\\new\\temp\\predict.csv", string.Format("{0},{1},{2},{3}\n", "P_Time", "H_Time", "H_D_Time", "user"));
        */
        }
        ...
        public async static void processLogs()
        {
            ...
            while (true)
            {
                if (MilraMode == MILRA_MODE.NONE)
                {
                    Thread.Sleep(3000);
                    continue;
                }
                else if (MilraMode == MILRA_MODE.LEARN)
                {
                    fileName = trainFile;
                }
                        ...
                        if (!"[Re]".Equals(currRawLine.Operation))
                        {
                            if ("[Pr]".Equals(currRawLine.Operation))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        var a = File.ReadAllLines(@"C:\Users\shayl\new\temp\all.txt");
                                        string[] b = new string[a.Length + 1];
                                        a.CopyTo(b, 0);
                                        b[a.Length] = currRawLine.KeyWord;
                                        File.WriteAllLines(@"C:\Users\shayl\new\temp\all.txt", b);
                                    }*/
