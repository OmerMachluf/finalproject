...
{
    public partial class MILRA_Service : ServiceBase
    {
        DataService dataService;
        public ServiceHost dataServiceHost = null;
        public const string BasePath = @"C:\Users\shayl\new\temp\";
        ...
        public MILRA_Service()
        {
            this.ServiceName = "MILRA_Service";
            InitializeComponent();
        }
        ...
        protected override void OnStop()
        {
            ...
            ProcessHandler.CheckAndSKillProcess("MILRA_KeyLogger");
        ...
        protected override void OnCustomCommand(int command)
        {
            ...
            switch (command)
            {
                case (int)Commands.StartBuilding:
                    Data2Csv.MilraMode = Data2Csv.MILRA_MODE.LEARN;
                    break;
                case (int)Commands.StartTesting:
                    Data2Csv.MilraMode = Data2Csv.MILRA_MODE.MONITOR;
                    break;
                case (int)Commands.StartDtour:
                    Data2Csv.MilraMode = Data2Csv.MILRA_MODE.DTOUR;
                    break;
                default:
                    break;
            }
